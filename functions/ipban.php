    ...
    if (is_writable(osc_base_path())) {
        echo '
            <div id="flash">'.spam_prot::newInstance()->_showPopup(
                '<h1 style="display: inline-block;"><i class="sp-icon attention margin-right float-left"></i>'.__('<strong>Path writable.</strong>',
                    'spamprotection').'</h1>',
        ...
        echo '
            <div id="flash">'.spam_prot::newInstance()->_showPopup(
                '<h1 style="display: inline-block;"><i class="sp-icon attention margin-right float-left"></i>'.__('<strong>Path NOT writable.</strong>',
                    'spamprotection').'</h1>',
                '
