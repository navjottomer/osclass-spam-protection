                ...
                <tr>
                    <td class="col-name">
                        ...
                        if (is_numeric($v['i_user_id'])) {
                            ...
                            echo(isset($user['s_name']) ? '<a href="' . osc_admin_base_url(true)
                                . '?page=users&action=edit&id=' . $v['i_user_id'] . '">' . $user['s_name'] . '</a>'
                                : '');
                        } else {
                    ...
                    <td class="col-name">
                        ...
                        <div class="actions">
                            <ul>
                                <li>
                                    <a href="<?php echo osc_admin_render_plugin_url('spamprotection/admin/ban_log.php?action=delete&id='
                                        . $v['pk_i_id']); ?>"><?php _e('Delete entry',
                                            'spamprotection'); ?></a>
                                </li>
                                <li>
                                    <a href="<?php echo osc_admin_render_plugin_url('spamprotection/admin/ban_log.php?action=activate&id='
                                        . $v['pk_i_id']); ?>"><?php _e('Activate user',
                                            'spamprotection'); ?></a>
                                </li>
                            </ul>
                        </div>
