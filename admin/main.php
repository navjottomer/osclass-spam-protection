...
?>
<div id="spamprot" class="<?php if (isset($data['sp_theme'])) {
    echo $data['sp_theme'];
} ?>">
    <div class="container">
        <ul class="tabs">
            <li class="tab-link<?php if (isset($settings) && $settings) {
                echo ' current';
            } ?>" data-tab="sp_settings"><a><?php _e('Ad Settings', 'spamprotection'); ?></a></li>
            <li class="tab-link<?php if (isset($comments) && $comments) {
                echo ' current';
            } ?>" data-tab="sp_comments"><a><?php _e('Comment Settings', 'spamprotection'); ?></a></li>
            <li class="tab-link<?php if (isset($contact) && $contact) {
                echo ' current';
            } ?>" data-tab="sp_contact"><a><?php _e('Contact Settings', 'spamprotection'); ?></a></li>
            <li class="tab-link<?php if (isset($security) && $security) {
                echo ' current';
            } ?>" data-tab="sp_security"><a><?php _e('Account Settings', 'spamprotection'); ?></a></li>
            <li class="tab-link<?php if (isset($tools) && $tools) {
                echo ' current';
            } ?>" data-tab="sp_tools"><a><?php _e('Tools', 'spamprotection'); ?></a></li>
            <li class="tab-link<?php if (isset($help) && $help) {
                echo ' current';
            } ?>" data-tab="sp_help"><a><?php _e('Help', 'spamprotection'); ?></a></li>
            <li class="tab-link float-right<?php if (isset($config) && $config) {
                echo ' current';
            } ?>" data-tab="sp_config"><a class="sp-icon tools"
                                          style="padding: 0;background-color: transparent;border: none;margin: 8px 10px 9px;"></a>
            </li>
        </ul>

        <form id="sp_save_settings" action="<?php echo osc_admin_render_plugin_url('spamprotection/admin/main.php'); ?>"
              method="POST">
            ...
            <div id="sp_settings" class="tab-content<?php if (isset($settings) && $settings) {
                echo ' current';
            } ?>">
                <?php include_once(osc_plugin_path('spamprotection/admin/settings.php')); ?>
            </div>

            <div id="sp_comments" class="tab-content<?php if (isset($comments) && $comments) {
                echo ' current';
            } ?>">
                <?php include_once(osc_plugin_path('spamprotection/admin/comments.php')); ?>
            </div>

            <div id="sp_contact" class="tab-content<?php if (isset($contact) && $contact) {
                echo ' current';
            } ?>">
                <?php include_once(osc_plugin_path('spamprotection/admin/contact.php')); ?>
            </div>

            <div id="sp_security" class="tab-content<?php if (isset($security) && $security) {
                echo ' current';
            } ?>">
                <?php include_once(osc_plugin_path('spamprotection/admin/security.php')); ?>
            </div>

            <div id="sp_tools" class="tab-content<?php if (isset($tools) && $tools) {
                echo ' current';
            } ?>">
                <?php include_once(osc_plugin_path('spamprotection/admin/tools.php')); ?>
            </div>

            <div id="sp_help" class="tab-content<?php if (isset($help) && $help) {
                echo ' current';
            } ?>">
        ...
        <div id="sp_config" class="tab-content<?php if (isset($config) && $config) {
            echo ' current';
        } ?>">
