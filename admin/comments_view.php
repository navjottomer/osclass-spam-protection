...
<div id="view_comment">
    ...
    <div class="comment_actions halfrow">
        <a class="btn btn-submit" onclick="return confirm('<?php _e('Are you sure you want to activate this comment?',
            'spamprotection'); ?>');" href="<?php echo osc_admin_render_plugin_url(osc_plugin_folder(__DIR__).'admin/comments_check.php?action=activate&id='. $params['id']); ?>"><?php _e('Activate comment', 'spamprotection'); ?></a>
        <a class="btn" onclick="return confirm('<?php _e('Are you sure you want to delete this comment?',
            'spamprotection'); ?>');" href="<?php echo osc_admin_render_plugin_url(osc_plugin_folder(__DIR__).'admin/comments_check.php?action=delete&id='. $params['id']); ?>"><?php _e('Delete comment', 'spamprotection'); ?></a>
        <a class="btn btn-red" onclick="return confirm('<?php _e('Are you sure you want to delete this comment and block this user for comments?',
            'spamprotection'); ?>');" href="<?php echo osc_admin_render_plugin_url(osc_plugin_folder(__DIR__).'admin/comments_check.php?action=block&id='. $params['id']); ?>"><?php _e('Delete comment and block user', 'spamprotection'); ?></a>
    </div>
